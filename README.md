...
var rotate = function (nums, k) {
    const n = nums.length;
    return nums.slice(n - k, n).concat(nums.slice(0, k + 1))
};

var nums = [1, 2, 3, 4, 5, 6, 7]; var k = 3;

var result = rotate(nums, k)
...
MyCircularDeque.prototype.getRear = function () {
    return this.isEmpty() ? -1 : this.arr[(this.rear - 1 + this.n) % this.n]
};
